...
public class CrawlerTest {
	...
	public static void main(String[] args) {
		...
		userpool[1] = new UserInfo("glwu_1027@sina.com", "wgl_1027");
		userpool[0] = new UserInfo("xushun007@163.com", "19871211");
		...
		userpool[6] = new UserInfo("shiwei072@hotmail.com", "0627401072");
		...
		WeiboUser iuser = new WeiboUser(seed, 0);
		 if(MaxDepth == -1){
		    	...
		    	while(!(queue.isEmpty())){
		    		...
		    		for(String uid : wp.Getfollowing(userpool,apppool)){
